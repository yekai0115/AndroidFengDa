...
import com.fengda.app.model.BandCardBase;
...
public class BindBankActivity extends BaseActivity implements View.OnClickListener, PermissionListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private ImageView bankImg,show_translucent;
    ...
    protected void initEvents() {
        ...
        if (state == 3) {
            ...
            String province = personAuth.getProvince_name();
            String city = personAuth.getCity_name();
            String county = personAuth.getCounty_name();
            ...
            provinceBean.setProvince_id(personAuth.getProvince_id());
            addrProvince = provinceBean;
            CityBean cityBean = new CityBean();
            cityBean.setName(city);
            cityBean.setCity_id(personAuth.getCity_id());
            addrCity = cityBean;
            AreaBean areaBean = new AreaBean();
            areaBean.setName(county);
            areaBean.setCounty_id(personAuth.getCounty_id());
            addrArea = areaBean;
            ...
            if (!StringUtils.isBlank(error_bank_logo)) {
                ...
                show_translucent.setVisibility(View.VISIBLE);
            }
            downLoadPic();
    ...
    protected void initViews() {
        ...
        show_translucent  = (ImageView) findViewById(R.id.show_translucent);
    ...
    private void showProvinceDialog() {
        new DialogSelectAddr().showProvincesDialog(BindBankActivity.this, Addrs.getProvinceNameList(), proivinceSelect, new DialogSelectAddr.OnItemClickedListener() {
            ...
            public void onConfirmClick(int dialogIndex, int selectedIndex) {
                ...
                ProvinceBean addrObject = Addrs.getProvinceObjects().get(selectedIndex);
                addrProvince = addrObject;
                if (addrProvince.getName().contains("自治区")){
                    tvProvince.setText(addrProvince.getName().substring(0,addrProvince.getName().length()-3));
                }else {
                    tvProvince.setText(addrProvince.getName());
                }
                tvCity.setText(getResources().getString(R.string.abc_select_city));
    ...
    private void sumbitInfo() {
        ...
        Call<BaseResponse<Object>> call = userBiz.bindBankSubmit(token,
                ...
                addrProvince.getProvince_id(),
                addrCity.getCity_id(),
                addrArea.getCounty_id(),
    ...
    private void updateAuthentication() {
        ...
        params.put("province_name", tvProvince.getText().toString());
        params.put("city_name", tvCity.getText().toString());
                ...
                .setCompressListener(new OnCompressListener() {
                    ...
                    public void onSuccess(File f) {
                        ...
                        Glide.with(mContext).load(f).fitCenter()
                                ...
                                .into(bankImg);
                        show_translucent.setVisibility(View.GONE);
                    }
