...
public interface APIService {
    ...
    Call<BaseResponse<List<DeclarationBean>>> declarationForm(@Header("X-AUTH-TOKEN") String token,
                                                              @Field("pic") String pic, @Field("money") String money, @Field("number") String number);
    ...
    @FormUrlEncoded
    Call<BaseResponse<Object>> joinJinYouActivity(@Header("X-AUTH-TOKEN") String token, @Field("activity_id") String activity_id);
